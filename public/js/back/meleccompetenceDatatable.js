    ...
    $(document).ready( function () {
        var table = $('#melec_competence_list').DataTable({
            language: {
            ...
            columns: [
                ...
                { data:'label'},
                {
                    ...
                    render: function(data){
                        return '<a href="/admin/meleccompetence/'+ data +'/edit">Editer</a>'
                }}
            ],
        });

        // $('#filter td').each( function (i) {
        //     var title = $('#melec_competence_list thead th').eq( $(this).index() ).text();
