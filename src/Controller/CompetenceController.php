...
class CompetenceController extends AbstractController
{
    ...
    /**
     * @Route("/{id}", name="competence_show", methods={"GET"}, requirements={"id":"\d+"})
     */
     ...
     *     name="competences_specialisation_list",
     *     requirements={"id":"\d+"}
     * )
     * @Rest\View(serializerGroups={"Default"})
     */
    public function getStudents(Specialisation $specialisation, CompetenceRepository $competencesRepository)
    {     
        return $competencesRepository->findBy([
