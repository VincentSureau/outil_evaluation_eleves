 ...
 */
final class Version20190125095854 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, specialiation_id INT DEFAULT NULL, srm_id INT DEFAULT NULL, cirfa_id INT DEFAULT NULL, school_id INT DEFAULT NULL, referent_id INT DEFAULT NULL, review_id INT DEFAULT NULL, city VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, gender VARCHAR(255) NOT NULL, birthplace VARCHAR(255) NOT NULL, birthdate DATETIME NOT NULL, INDEX IDX_B723AF33CAB27BA7 (specialiation_id), INDEX IDX_B723AF33EF2A5E9F (srm_id), INDEX IDX_B723AF336F6AD364 (cirfa_id), INDEX IDX_B723AF33C32A47EE (school_id), INDEX IDX_B723AF3335E47E35 (referent_id), UNIQUE INDEX UNIQ_B723AF333E2E969B (review_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE specialisation (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE school (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, number VARCHAR(255) DEFAULT NULL, mail VARCHAR(255) DEFAULT NULL, academy VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
