 ...
 */
final class Version20190412090704 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sncompetence_sntask (sncompetence_id INT NOT NULL, sntask_id INT NOT NULL, INDEX IDX_1636B3519DB632B2 (sncompetence_id), INDEX IDX_1636B351FA9C87CF (sntask_id), PRIMARY KEY(sncompetence_id, sntask_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sntask (id INT AUTO_INCREMENT NOT NULL, specialisation_id INT NOT NULL, label LONGTEXT NOT NULL, reference VARCHAR(255) NOT NULL, INDEX IDX_694C13D95627D44C (specialisation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sncompetence_sntask ADD CONSTRAINT FK_1636B3519DB632B2 FOREIGN KEY (sncompetence_id) REFERENCES sncompetence (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE sncompetence_sntask ADD CONSTRAINT FK_1636B351FA9C87CF FOREIGN KEY (sntask_id) REFERENCES sntask (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sncompetence_sntask DROP FOREIGN KEY FK_1636B3519DB632B2');
        $this->addSql('ALTER TABLE sncompetence_sntask DROP FOREIGN KEY FK_1636B351FA9C87CF');
        ...
        $this->addSql('DROP TABLE sncompetence_sntask');
